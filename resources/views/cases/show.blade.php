...
<style>
    ...
    .activities{padding:20px;display:grid;gap:12px}.activity{border:1px solid #dce5e9;border-radius:14px;padding:16px}.activity h3{margin:0 0 8px}.activity-meta{display:flex;gap:8px;flex-wrap:wrap;margin-bottom:8px}.source-skb{background:#dff7ea;color:#17633a}.source-mokav2{background:#e8efff;color:#244c9b}.reports{display:grid;gap:8px;margin-top:12px}.report{background:#f5f8fa;border-radius:10px;padding:11px}.fab{position:fixed;right:25px;bottom:25px;width:58px;height:58px;border-radius:50%;border:0;background:var(--blue);color:#fff;font-size:30px;box-shadow:0 12px 30px #176b8755;cursor:pointer}
