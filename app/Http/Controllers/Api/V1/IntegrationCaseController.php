...
class IntegrationCaseController extends Controller
{
    ...
    private function rules(): array
    {
        return [
            ...
            'service_keywords' => ['nullable', 'array'],
            'service_keywords.*.source_id' => ['nullable', 'string', 'max:191'],
            'service_keywords.*.jabatan' => ['nullable', 'string', 'max:191'],
            'service_keywords.*.keyword' => ['required_with:service_keywords', 'string', 'max:191'],
            'service_keywords.*.jenis_agenda' => ['nullable', 'string', 'max:50'],
